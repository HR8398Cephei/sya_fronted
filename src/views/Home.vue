...
export default {
  ...
  methods: {
    ...
    async getWorkList() {
      ...
      // this.workPageSize = aaa.data.workPageSize
      // //console.log(aaa.data.workPageSize);
      // //console.log(this.workPageSize);
      // const res = await axios.post(
      //   this.$helper.endpointUrl('/Work/ViewAllWork'),
      //   {
      //     pagenum: 1,
      //     workPageSize: this.workPageSize,
      //   },
      //   {
      //     withCredentials: true,
      //   }
      ...
      //   return
      // }
      // this.workList[0] = res.data.worklist[this.workPageSize - 1]
      // this.workList[1] = res.data.worklist[this.workPageSize - 2]
      // this.workList[2] = res.data.worklist[this.workPageSize - 3]
      // this.workList[3] = res.data.worklist[this.workPageSize - 4]
      console.log(res.data.worklist)
    ...
    async getAnnounce() {
      ...
      if (this.$store.state.role == 0) {
        res = await axios.post(
          ...
          {
            pagenum: 1,
            pagesize: this.announcePageSize,
          },
          {
            withCredentials: true,
          }
      ...
      this.annoList = res.data.announcementItem
      // this.announcePageSize = res.data.workPageSize
      // //console.log(this.announcePageSize);
      // if (this.$store.state.role == 0) {
      //   res = await axios.post(
      //     this.$helper.endpointUrl('/Announce/GetSendAnnounce'),
      //     {
      //       pagenum: 1,
      //       workPageSize: this.announcePageSize,
      //     },
      //     {
      //       withCredentials: true,
      //     }
      ...
      // this.annoList[0] = res.data.announceItem[this.announcePageSize - 1]
      // this.annoList[1] = res.data.announceItem[this.announcePageSize - 2]
      // this.annoList[2] = res.data.announceItem[this.announcePageSize - 3]
      // this.annoList[3] = res.data.announceItem[this.announcePageSize - 4]
      // this.$forceUpdate()
      // this.workPageSize=res.data.workPageSize/res.data.pagenum;
